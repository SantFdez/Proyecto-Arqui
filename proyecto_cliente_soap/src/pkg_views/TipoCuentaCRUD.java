 ...
 * @author Trancos
 */
public class TipoCuentaCRUD extends javax.swing.JFrame {

    /**
     * Creates new form CuentaBancCRUD
     */
    public TipoCuentaCRUD() {
        initComponents();
    }
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtContar, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
          ...
          String ls_nombre;
        try {
            ls_nombre = port.buscarTipoCuenta(txt2.getText());
            if (ls_nombre != null) {
    ...
    private void btnInsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInsertarActionPerformed
         int resultado;
        try {
            resultado = port.insertarTipoCuenta(txt2.getText());
            if (resultado == 1) {
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        int resultado;
        try {
            resultado = port.eliminarTipoCuenta(txt1.getText());
            if (resultado == 1) {
  ...
  int resultado;
        try {
            resultado = port.modificarTipoCuenta(txt1.getText(), txt2.getText());
            if (resultado == 1) {
    ...
    private void btnContarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContarActionPerformed
        ...
        String ls_nombre;
        try {
            ls_nombre = port.contarCuenta();
            if (ls_nombre != null) {
                String[] arr=ls_nombre.split(",");
                txtContar.setText(arr[0]);
                //lblMsj.setText( "Registro encontrado");
            } else {
                //lblMsj.setText("No se pudo encontrar el registro");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TipoCuentaCRUD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TipoCuentaCRUD().setVisible(true);
            }
        });
    }
